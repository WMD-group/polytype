...
###############################################################################
###############################################################################
# This code is revised from https://github.com/rmsolgi/geneticalgorithm to fulfill
# our purpose of use, to generate stacking sequences consisting of pseudo -1 and 1.
...
class geneticalgorithm():
    ...
    def run(self):
        ...
        plt.plot(re, color="#6c3376", linewidth=3)
        plt.xlabel('Iteration')
        plt.ylabel('Objective function')
        #plt.ylim(self.best_function-1, self.best_function+1)
        plt.title('Genetic Algorithm')
        plt.savefig('/Users/lizhenzhu/Downloads/'+'ga.tif', dpi = 600)
        plt.show()
